    ...
    function ProductsAdminController($scope, $timeout, $state, $window, product, Authentication, Notification, Upload) {
            ...
            if ($window.confirm('Are you sure you want to delete?')) {
                vm.product.$remove(function() {
                    ...
                    Notification.success({
                        message: '<i class="glyphicon glyphicon-ok"></i> Product deleted successfully!'
                    });
                });
            }
        }
        ...
        function save(isValid) {
            ...
            if (vm.product.category) {
                ...
                var uniquecats = format.filter(function(value, index) {
                    return format.indexOf(value) == index
                });
            ...
            function successCallback(res) {
                ...
                Notification.success({
                    message: '<i class="glyphicon glyphicon-ok"></i> Product saved successfully!'
                });
            }
            ...
            function errorCallback(res) {
                Notification.error({
                    ...
                    title: '<i class="glyphicon glyphicon-remove"></i> Product save error!'
                });
            }
        }
    }
