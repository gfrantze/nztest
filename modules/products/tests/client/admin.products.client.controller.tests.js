  ...
  describe('Products Admin Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleArticlePostData = new ProductsService({
          title: 'An Article about MEAN',
          content: 'MEAN rocks!'
        });

        $scope.vm.product = sampleArticlePostData;
      });
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ProductsService) {
        // Set POST response
        $httpBackend.expectPOST('/api/products', sampleArticlePostData).respond(mockArticle);
      ...
      it('should call Notification.error if error', function () {
        ...
        $httpBackend.expectPOST('/api/products', sampleArticlePostData).respond(400, {
